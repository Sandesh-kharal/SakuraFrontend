...
const ServiceSection = () => {
  return (
      ...
      <div className='text-center mt-10 display flex flex-col items-center justify-center'> 
         <div className='text-5xl text-black font-bold mt-10'>Our Services</div>
          <p className=' text-black text-lg mt-4 mb-10 max-w-lg'>From your first Japanese lesson to landing at Narita Airport. </p>
      </div>
   


   <div className='grid grid-cols-1 md:grid-cols-3 gap-20 mt-10 mb-20  max-w-5xl mx-auto'>
